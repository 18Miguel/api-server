...
let timestampFieldComparison: ClassType<FilterFieldComparison<Date>>;

export function getOrCreateTimestampFieldComparison(): ClassType<FilterFieldComparison<Date>> {
    if (timestampFieldComparison) return timestampFieldComparison;

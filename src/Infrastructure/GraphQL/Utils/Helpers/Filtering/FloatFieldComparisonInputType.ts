...
let floatFieldComparison: ClassType<FilterFieldComparison<number>>;

export function getOrCreateFloatFieldComparison(): ClassType<FilterFieldComparison<number>> {
    if (floatFieldComparison) return floatFieldComparison;
